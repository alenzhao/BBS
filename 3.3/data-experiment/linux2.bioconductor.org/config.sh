...
export BBS_OUTGOING_MAP="source:linux2.bioconductor.org/buildsrc win.binary:moscato2/buildbin mac.binary:morelia/buildbin"
...
export BBS_REPORT_NODES="linux2.bioconductor.org moscato2:bin morelia:bin"
