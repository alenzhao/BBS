...
export BBS_OUTGOING_MAP="source:linux2.bioconductor.org/buildsrc"
...
export BBS_REPORT_NODES="linux2.bioconductor.org"
...
export BBS_NOTIFY_NODES="linux2.bioconductor.org"
