#!/bin/bash
# ================================================================
# Settings shared by all the Unix nodes involved in the 3.3 builds
# ================================================================
...
export BBS_CENTRAL_RHOST="linux2.bioconductor.org"
export BBS_CENTRAL_RUSER="biocbuild"
export BBS_CENTRAL_RDIR="/home/biocbuild/public_html/BBS/$BBS_BIOC_VERSIONED_REPO_PATH"
export BBS_CENTRAL_BASEURL="http://linux2.bioconductor.org/BBS/$BBS_BIOC_VERSIONED_REPO_PATH"
