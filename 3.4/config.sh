#!/bin/bash
# ================================================================
# Settings shared by all the Unix nodes involved in the 3.4 builds
# ================================================================
...
export BBS_CENTRAL_RHOST="linux1.bioconductor.org"
export BBS_CENTRAL_RUSER="biocbuild"
export BBS_CENTRAL_RDIR="/home/biocbuild/public_html/BBS/$BBS_BIOC_VERSIONED_REPO_PATH"
export BBS_CENTRAL_BASEURL="http://linux1.bioconductor.org/BBS/$BBS_BIOC_VERSIONED_REPO_PATH"
