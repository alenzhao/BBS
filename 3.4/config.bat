@rem ===================================================================
@rem Settings shared by all the Windows nodes involved in the 3.4 builds
@rem ===================================================================
...
set BBS_CENTRAL_RHOST=linux1.bioconductor.org
set BBS_CENTRAL_RUSER=biocbuild
set BBS_CENTRAL_RDIR=/home/biocbuild/public_html/BBS/%BBS_BIOC_VERSIONED_REPO_PATH%
set BBS_CENTRAL_BASEURL=http://linux1.bioconductor.org/BBS/%BBS_BIOC_VERSIONED_REPO_PATH%
