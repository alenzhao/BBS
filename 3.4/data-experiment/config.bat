@rem ===================================================================================
@rem Settings shared by all the Windows nodes involved in the 3.4-data-experiment builds
@rem ===================================================================================


set BBS_MODE=data-experiment

set BBS_BIOC_MANIFEST_FILE=bioc-data-experiment.3.4.manifest
...
@rem Where is it?
set BBS_MEAT0_RHOST=linux1.bioconductor.org
set BBS_MEAT0_RUSER=biocbuild
set BBS_MEAT0_RDIR=/home/biocbuild/bbs-3.4-data-experiment/MEAT0
