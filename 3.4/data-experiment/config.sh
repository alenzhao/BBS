#!/bin/bash
# ================================================================================
# Settings shared by all the Unix nodes involved in the 3.4-data-experiment builds
# ================================================================================


export BBS_MODE="data-experiment"

export BBS_BIOC_MANIFEST_FILE="bioc-data-experiment.3.4.manifest"
...
# Where is it?
export BBS_MEAT0_RHOST="linux1.bioconductor.org"
export BBS_MEAT0_RUSER="biocbuild"
export BBS_MEAT0_RDIR="/home/biocbuild/bbs-3.4-data-experiment/MEAT0"
